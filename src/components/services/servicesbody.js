                            ...
                            <div className="row">
                                <div className="col-xs-12 col-sm-6 wrap-none text-center">
                                    <div className="panel panel-default panel-price">
                                        ...
                                        <a href="download.html" className="btn btn-primary wrap-vertical-lg">Book Demo</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-xs-12 col-sm-6 wrap-none text-center">
                                    <div className="panel panel-default panel-price">
                                        ...
                                        <a href="member/register/monthly-hosting-solution/index.html" className="btn btn-primary wrap-vertical-lg">Book Demo</a>
                                    </div>
                                </div>
                            </div>
                        </div>
